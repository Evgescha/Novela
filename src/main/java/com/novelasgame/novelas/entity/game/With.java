...
public class With {
	 ...
	 *  with dspr - показать плавно, за 0.2 секунды
		...
		with fade2 - 2 сек with flash - 2 сек (fade to white)
		with fade3 - 3 сек with fiash_red - 2 сек (fade to red)
		with hpunch - трясёт экран по горизонтали with vpunch - трясёт экран по вертикали
